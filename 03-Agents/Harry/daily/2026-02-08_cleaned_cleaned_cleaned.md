...
## Decisions
- **Cost Policy Update**: Migrated sub-agents (spark-engineer, radar-scout, prism-analyst, pixel-merchant, nexus-integrator) to Gemini Flash to achieve ~200x cost savings. Harry uses Opus 4.6; heavy coding tasks routed to Ava (via Claude Code/Codox); N8N bots utilize gpt-4o-mini.

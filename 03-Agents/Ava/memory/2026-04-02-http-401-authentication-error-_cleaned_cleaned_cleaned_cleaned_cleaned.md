...
**Blockers**
- **Resolved**: BigQuery query corrected to use `Sales_Record_Number`, `Quantity`, and `Net_Sale` (replacing `Amazon_Order_Id`).

**Knowledge**
- **Production Matrix Requirements**: Must capture product type code, units, net sales, production branch, hardware/location, asset/file types, and technical specs (jig, cutline, white layer, bleed).
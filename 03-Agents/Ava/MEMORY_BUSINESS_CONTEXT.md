# AVA Memory — Business Context
*Exported: 2026-04-07 | Source: Ava's curated MEMORY.md*
...
### HB401 Sprint (Mar 2128)  Status as of Mar 28 (DEADLINE DAY)
- **Sprint goal:** 31 device×design combos across 20 champion designs, iPhone 13 = #1 gap
- **Days 1-5:** Zero PH team progress (flagged daily)
- **Day 6 (Mar 26):** BREAKTHROUGH  Patricia uploaded 16 HB4 combos (NARUICO, DRGBSUSC, NARUCHA, OHIOLOGO + 5 others)
- **Day 7 (Mar 27):** Full team active  Jeffrey completed Harry Potter HB4 IPH12/IPH13 smart objects (HPOTDH37 ✅), Chadle listed HB401 sports designs, Nesley doing AI lifestyle images, Danica re-replicated 5 Art lineups (88,176 SKUs!)
- **Still missing:** PNUTHAL, PNUTCHA (Peanuts P1 designs)  unconfirmed as of Mar 27
- **Gap tracker:** 85/3,782 entries updated as done

### License Compliance Alerts (updated Mar 28)
- **NFL:** Expires Mar 31  3 DAYS. $25K/yr renewal, ~$97K annualized revenue. RENEW recommended. Flagged 4+ times, no Cem confirmation. MONDAY IS LAST BUSINESS DAY.
- **CLC:** Royalty reports overdue past Mar 20 deadline. Breach of contract risk.
- **NBA:** $200K MG shortfall ($13K rev)  structural problem.
- **Shelby:** $27.5K MG shortfall ($1.5K rev)  structural problem.
- **Tottenham (Katie Moran):** Factory audit needed for Brand Comply items 5139935/5139933.
- **NBCU POs:** ✅Cem acknowledged PO 3400799538 on Mar 27. Resolved.
- **FC Barcelona:** Updated style guide + product approval process from CAA (Laney Steed). Compliance review needed.
...
### Walmart API Status (Mar 20)
- Two credential sets (old c7c685fa + new 88df399e) - both auth + read OK, item creation FAILS
- Inline JSON →ERROR "glitch on our end", file upload →stuck in RECEIVED
- 4.02M existing items in Walmart catalog (uploaded via old Zero integration)
- GTIN-14 format required (EAN-13 with leading zero)
- Feed to monitor: 189EA3C309ED5B609D43621011303284@AXkBBwA
...
## Compaction Tuning (configured 2026-03-08)
- safeguard mode, 6 recent turns preserved, 8K recent tokens, memory flush enabled
- Hybrid search: BM25 + vector, MMR diversity, 30-day temporal decay
- lossless-claw plugin: evaluated, deferred 2 weeks (too new, published 3 hours before evaluation)

## Fireflies.ai
- API key: `5f6de86e-7555-45f6-b698-afa3bed64a44`
...
- **PHP codebase**: 192.168.20.57 (XAMPP, likely Windows) - `C:xampphtdocs`
...
## Business Dashboard (ecell.app)
- **Repo:** gemc99-boop/business-dashboard on GitHub
- **Deploy target:** Cloud Run service `ecell-dashboard` in GCP project `opsecellglobal`, region `us-east1`
- **To add tiles:** Edit repo →redeploy with `gcloud run deploy`
- **Source:** Harry handoff Mar 22

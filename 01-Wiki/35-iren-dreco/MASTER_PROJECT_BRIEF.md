...
> **File cleanup note (2026-04-04):** Once IREN/DRECO replacement is tested and validated, print templates will be deployed to each local office (FL, UK, PH). At that point, all local Mac Studio copies of template files can be deleted — each office runs its own instance. GDrive remains the master archive.  

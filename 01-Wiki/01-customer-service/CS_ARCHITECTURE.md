...
AI-assisted customer service for **website channels only** — ecellglobal.com, goheadcase.com, and future niche microsites. eBay and Amazon CS remain on their native platforms (handled by staff). **Draft-only mode** initially for human review.

### Scope Change (Feb 11, 2026)
- eBay and Amazon CS: Staff use native platform messaging (too many compliance risks for AI)
- Website CS: Full AI automation with order lookup, ticketing, and conversation history
- Future microsites: Sports teams, anime, entertainment characters — each may have unique branding/tone
...
## Related
- [[wiki/01-customer-service/CS_ARCHITECTURE_V2|CS Architecture V2]] — Multi-channel evolution
- [[wiki/01-customer-service/MARKETPLACE_RULES|Marketplace Rules]] — Amazon/eBay compliance
- [[wiki/01-customer-service/SOP_EMAIL_HANDLING|SOP: Email Handling]] — Email procedures
- [[wiki/15-email-triage/EMAIL_TRIAGE_PROJECT|Email Triage Project]] — N8N automation

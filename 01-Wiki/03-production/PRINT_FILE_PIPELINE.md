...
## Related
- [[wiki/03-production/DAILY_PRINT_PRODUCTION|Daily Print Production]] — Full production workflow
- [[wiki/23-drew-handover/BEA_CREATIVE_PROCESS|Bea Creative Process]] — Camera holes, image replication
- [[wiki/06-design-automation/DESIGN_SYSTEM|Design System]] — Design automation integration
- [[wiki/09-creative-pipeline/CREATIVE_PIPELINE_ARCHITECTURE|Creative Pipeline]] — Upstream creative workflow
- [[wiki/23-drew-handover/PATRICK_WORKFLOW_PICKLIST_TO_IMAGE|Patrick's Workflow]] — How print files trigger today

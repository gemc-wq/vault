...
**Examples:**
- `HTPCR-IPH17PMAX-NARUICO-AKA` → Soft Gel Case, iPhone 17 Pro Max, Naruto Iconic, Akatsuki variant
...
|--------------------------|------------------------|---------------|
| `HTPCR` | `FHTPCR` | ✅ YES — Soft Gel Case |
...
|------|-----------|-------------|------------|
| HTPCR / FHTPCR | HTPCR | Soft Gel Case | $17.95 |
| HB401 / FHB401 | HB401 | Hard Case | $19.95 |

...
**⚠️ H8939/HSTWH are NOT in the PO pipeline.** No per-unit blanks to order — just vinyl rolls restocked when low. Procurement system handles physical case/accessory blanks only (HTPCR, HB401, HB6, HB7, HLBWH, HDMWH). Vinyl roll reorder is a simple consumables alert, not the split/PO workflow.
...
**Key rule: Bundles (BD) and multi-packs = multiple EPS files per 1 SKU.**
- BD suffix = bundle (console + controller). 2 print files = 1 product.
- HSTWH = sticker 2-pack. 2 print files = 1 product.
- Cost calculation must sum ALL files belonging to one product SKU.

**Reference table (from RIP data, Cem 2026-03-20):**

| Product | Type | Sheets/unit | ft² total | Cost @ $0.75 |
|---------|------|-------------|-----------|--------------|
| H8939-DS4CT/DS5CT | Controller skin | 1 | ~0.41 | $0.31 |
| H8939-SRSSCS | Xbox S console | 1 | ~1.86 | $1.40 |
| H8939-SRSSBD | Xbox S bundle | 2 | ~2.27 | $1.71 |
| H8939-SWITCHBD | Switch bundle | 2 | ~2.92 | $2.19 |
| H8939-PS5BD | PS5 bundle | 2+ | ~3.42 | $2.56 |
